...
@Component({
    ...
    providers: [LevantamientoRNService, CursesService, StudentsService, SettingsService] // the provider of RN
})

export class LevantamientoRNDetailsAdminComponent implements OnInit, OnDestroy {
    ...
    ngOnInit(): any {
        this.requestSubscribe = this._route.params.subscribe(params => {
            ...
            console.log(this.levantamientoRNId);
