...
var TableRNComComponent = (function () {
    function TableRNComComponent(_levantamientoService, _cursesService) {
    ...
    TableRNComComponent.prototype.ngOnInit = function () {
        var _this = this;
     ...
     */
    TableRNComComponent.prototype.orderData = function (array) {
    ...
    TableRNComComponent.prototype.generateReport = function () {
        console.log("Generando reportes");
    };
    TableRNComComponent = __decorate([
        core_1.Component({
            moduleId: module.id,
    ...
    return TableRNComComponent;
}());
exports.TableRNComComponent = TableRNComComponent;
//# sourceMappingURL=tableRNCom.component.js.map