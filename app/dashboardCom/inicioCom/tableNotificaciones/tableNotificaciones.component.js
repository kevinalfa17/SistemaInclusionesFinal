...
var TableNotificacionesComComponent = (function () {
    function TableNotificacionesComComponent(_route, _router, _notificationService, _studentsService) {
        this._route = _route;
    ...
    TableNotificacionesComComponent.prototype.ngOnInit = function () {
     ...
     */
    TableNotificacionesComComponent.prototype.divideNotificationsType = function (list) {
        var _this = this;
     ...
     */
    TableNotificacionesComComponent.prototype.changeCheckboxData = function (notiID, state, tipo, index) {
     ...
     * @param noti The object of the notification
     */
    TableNotificacionesComComponent.prototype.redirectNotification = function (noti) {
        if (noti.tipo == 'inc') {
        }
     ...
     * @param noti
     */
    TableNotificacionesComComponent.prototype.deleteNotification = function (notiID, tipo, index) {
    ...
    TableNotificacionesComComponent = __decorate([
        core_1.Component({
            moduleId: module.id,
            selector: 'table-Notificaciones-Com-cmp',
    ...
    return TableNotificacionesComComponent;
}());
exports.TableNotificacionesComComponent = TableNotificacionesComComponent;
