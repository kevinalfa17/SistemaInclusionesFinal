 ...
 */
    LevantamientoService.prototype.editAReq = function (id, request) {
        return this._http.put(this._Server.direction + 'ce/SkipRequirements/Commission?id=' + id, request).map(function (res) { return res.json(); });
    };
